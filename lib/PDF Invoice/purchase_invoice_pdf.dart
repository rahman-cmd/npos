...
class PurchaseInvoicePDF {
  static Future<void> generatePurchaseDocument(
      PurchaseTransaction transactions, BusinessInformation personalInformation, BuildContext context, BusinessSettingModel businessSetting,
      {bool? isShare}) async {
                      ...
                      child: pw.Row(
                        ...
                        children: [
                          ...
                          pw.Column(
                            ...
                            children: [
                              pw.Text(
                                "Paid Amount: ${formatPointNumber(((transactions.totalAmount ?? 0) - (transactions.dueAmount ?? 0)) + (transactions.changeAmount ?? 0))}",
