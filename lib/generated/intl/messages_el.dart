...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addIncome":
            MessageLookupByLibrary.simpleMessage("Προσθήκη εισοδήματος"),
        ...
        "barcodeGenerator":
            MessageLookupByLibrary.simpleMessage("Γεννήτρια Barcode"),
        ...
        "businessCat":
            MessageLookupByLibrary.simpleMessage("Κατηγορία Επιχειρήσεων"),
        "businessName": MessageLookupByLibrary.simpleMessage(
            "Επωνυμία εταιρείας και επιχείρησης"),
        "buyPremium":
            MessageLookupByLibrary.simpleMessage("Αγοράστε Premium Πρόγραμμα"),
        ...
        "chooseCustomer":
            MessageLookupByLibrary.simpleMessage("Επιλέξτε Πελάτη"),
        "chooseSupplier":
        ...
        "collectDues":
            MessageLookupByLibrary.simpleMessage("Συλλέξτε Οφειλόμενο"),
        ...
        "companyAddress":
            MessageLookupByLibrary.simpleMessage("Διεύθυνση εταιρίας"),
        "confirmDelete":
        ...
        "confirmPassword":
            MessageLookupByLibrary.simpleMessage("Επιβεβαίωση Κωδικού"),
        "confirmSMSTo":
            MessageLookupByLibrary.simpleMessage("Επιβεβαιώστε το SMS στο"),
        ...
        "customerPhoneNumber":
            MessageLookupByLibrary.simpleMessage("Αριθμός Τηλεφώνου Πελάτη"),
        "dailyTransaction":
            MessageLookupByLibrary.simpleMessage("Ημερήσιες συναλλαγές"),
        ...
        "dueCollection":
            MessageLookupByLibrary.simpleMessage("Οφειλόμενη είσπραξη"),
        ...
        "emailText":
            MessageLookupByLibrary.simpleMessage("ΗΛΕΚΤΡΟΝΙΚΗ ΔΙΕΥΘΥΝΣΗ"),
        ...
        "enterABrandName":
            MessageLookupByLibrary.simpleMessage("Εισάγετε το όνομα μάρκας"),
        "enterAValidDiscount":
            MessageLookupByLibrary.simpleMessage("Εισάγετε μια έγκυρη έκπτωση"),
        "enterAValidOTP":
            MessageLookupByLibrary.simpleMessage("Εισάγετε ένα έγκυρο OTP"),
        "enterAValidStock":
            MessageLookupByLibrary.simpleMessage("Εισάγετε ένα έγκυρο απόθεμα"),
        "enterAmount":
        ...
        "enterCapacity":
            MessageLookupByLibrary.simpleMessage("Εισάγετε Χωρητικότητα"),
        ...
        "enterDealerPrice":
            MessageLookupByLibrary.simpleMessage("Εισάγετε τιμή αντιπροσώπου"),
        "enterDiscount":
            MessageLookupByLibrary.simpleMessage("Εισάγετε έκπτωση"),
        ...
        "enterOpeningBalance":
            MessageLookupByLibrary.simpleMessage("Εισάγετε το αρχικό υπόλοιπο"),
        "enterProductCode":
            MessageLookupByLibrary.simpleMessage("Εισαγάγετε κωδικό προϊόντος"),
        "enterProductName":
            MessageLookupByLibrary.simpleMessage("Εισάγετε το όνομα προϊόντος"),
        "enterPurchasePrice":
            MessageLookupByLibrary.simpleMessage("Εισάγετε τιμή αγοράς"),
        "enterQuantity":
            MessageLookupByLibrary.simpleMessage("Εισάγετε ποσότητα"),
        "enterRefNumber": MessageLookupByLibrary.simpleMessage(
            "Εισαγάγετε τον αριθμό αναφοράς"),
        "enterSaltingPrice":
            MessageLookupByLibrary.simpleMessage("Εισάγετε τιμή πώλησης"),
        ...
        "enterValidOTP":
            MessageLookupByLibrary.simpleMessage("Εισάγετε έγκυρο OTP"),
        "enterWeight": MessageLookupByLibrary.simpleMessage("Εισάγετε Βάρος"),
        "enterWholesalePrice":
            MessageLookupByLibrary.simpleMessage("Εισάγετε τιμή χονδρικής"),
        ...
        "expenseCat":
            MessageLookupByLibrary.simpleMessage("Κατηγορίες δαπανών"),
        "expenseDate":
            MessageLookupByLibrary.simpleMessage("Ημερομηνία Εξόδων"),
        ...
        "haveAcc":
            MessageLookupByLibrary.simpleMessage("Έχετε ήδη λογαριασμό?"),
        "hintEmail":
            MessageLookupByLibrary.simpleMessage("Εισάγετε τη διεύθυνση email"),
        "hintPassword":
            MessageLookupByLibrary.simpleMessage("Εισάγετε τον κωδικό"),
        ...
        "incomeCategories":
            MessageLookupByLibrary.simpleMessage("Κατηγορίες εισοδήματος"),
        "incomeDate":
        ...
        "logInWithMail":
            MessageLookupByLibrary.simpleMessage("Είσοδος με email"),
        "logOut": MessageLookupByLibrary.simpleMessage("Αποσύνδεση"),
        "loginWithPhone":
            MessageLookupByLibrary.simpleMessage("Είσοδος με τηλέφωνο"),
        ...
        "lossProfitReport":
            MessageLookupByLibrary.simpleMessage("Αναφορά Ζημιών/Κερδών"),
        "lp": MessageLookupByLibrary.simpleMessage("Ζημιά/Κέρδος"),
        "lpDetails":
            MessageLookupByLibrary.simpleMessage("Στοιχεία Ζημίας/Κέρδους"),
        ...
        "noDueSelected":
            MessageLookupByLibrary.simpleMessage("Δεν Εχει Επιλεγεί Οφειλή"),
        ...
        "openingBalance":
            MessageLookupByLibrary.simpleMessage("Ισολογισμός έναρξης"),
        ...
        "passwordsDoNotMatch":
            MessageLookupByLibrary.simpleMessage("Οι κωδικοί δεν ταιριάζουν"),
        "payForSubscribe":
            MessageLookupByLibrary.simpleMessage("Πληρώστε για Συνδρομή"),
        "payableAmount": MessageLookupByLibrary.simpleMessage("Πληρωτέο ποσό"),
        "payment": MessageLookupByLibrary.simpleMessage("Πληρωμή"),
        "paymentComplete":
            MessageLookupByLibrary.simpleMessage("Ολοκλήρωση πληρωμής"),
        "paymentFailed":
        ...
        "paymentMethods":
            MessageLookupByLibrary.simpleMessage("Τρόποι Πληρωμής"),
        "paymentSuccess":
        ...
        "paymentWasSuccessful":
            MessageLookupByLibrary.simpleMessage("Η πληρωμή ήταν επιτυχής!"),
        ...
        "powerdedByNpos":
            MessageLookupByLibrary.simpleMessage("Υποστηρίζεται από Npos"),
        ...
        "purchaseConfirmed":
            MessageLookupByLibrary.simpleMessage("Επιβεβαίωση αγοράς"),
        "purchaseDetails":
        ...
        "purchasePremium":
            MessageLookupByLibrary.simpleMessage("Αγορά Premium Πρόγραμμα"),
        "purchasePrice": MessageLookupByLibrary.simpleMessage("Τιμή αγοράς"),
        "purchaseReport":
            MessageLookupByLibrary.simpleMessage("Αναφορά αγοράς"),
        "purchaseReturnReport":
            MessageLookupByLibrary.simpleMessage("Αναφορά επιστροφής αγορών"),
        ...
        "receivedAmount":
            MessageLookupByLibrary.simpleMessage("Παραληφθέν ποσό"),
        "recentTransaction":
        ...
        "rememberMeLater":
            MessageLookupByLibrary.simpleMessage("Να με θυμάσαι αργότερα"),
        ...
        "returnedDate":
            MessageLookupByLibrary.simpleMessage("Ημερομηνία επιστροφής"),
        "returnedItem":
            MessageLookupByLibrary.simpleMessage("Επιστρεφόμενο είδος"),
        ...
        "salesReturnReport":
            MessageLookupByLibrary.simpleMessage("Αναφορά επιστροφής πωλήσεων"),
        ...
        "searchProduct":
            MessageLookupByLibrary.simpleMessage("Αναζήτηση Προϊόντος"),
        ...
        "selectLang":
            MessageLookupByLibrary.simpleMessage("Επιλέξτε την γλώσσα σας"),
        "selectProductCategory": MessageLookupByLibrary.simpleMessage(
            "Επιλέξτε Κατηγορία Προϊόντος"),
        "selectProductUnit":
            MessageLookupByLibrary.simpleMessage("Επιλέξτε Μονάδα Προϊόντος"),
        "selectVariations":
        ...
        "setUpNewPassword":
            MessageLookupByLibrary.simpleMessage("Ρυθμίστε νέο κωδικό"),
        "setUpProfile":
            MessageLookupByLibrary.simpleMessage("Ρυθμίστε το προφίλ σας"),
        ...
        "shopRemainingBalance":
            MessageLookupByLibrary.simpleMessage("Υπόλοιπο Καταστήματος"),
        ...
        "skipTheUpdate":
            MessageLookupByLibrary.simpleMessage("Παράκαμψη της ενημέρωσης"),
        "sl": MessageLookupByLibrary.simpleMessage("Α/Α"),
        "smartWatch": MessageLookupByLibrary.simpleMessage("Έξυπνο Ρολόι"),
        "socialMarketing":
            MessageLookupByLibrary.simpleMessage("Κοινωνική Μάρκετινγκ"),
        "somethingIs": MessageLookupByLibrary.simpleMessage("Κάτι είναι"),
        "staffLogin":
            MessageLookupByLibrary.simpleMessage("Είσοδος προσωπικού"),
        "startDate": MessageLookupByLibrary.simpleMessage("Ημερομηνία Έναρξης"),
        "startNewSale":
            MessageLookupByLibrary.simpleMessage("Έναρξη νέας πώλησης"),
        ...
        "successfullyPaid":
            MessageLookupByLibrary.simpleMessage("Πληρώθηκε με επιτυχία"),
        "supplerPay":
        ...
        "totalCategories":
            MessageLookupByLibrary.simpleMessage("Συνολικές Κατηγορίες"),
        "totalDue": MessageLookupByLibrary.simpleMessage("Σύνολο οφειλόμενου"),
        "totalDueAmount":
            MessageLookupByLibrary.simpleMessage("Συνολικό Οφειλόμενο Ποσό"),
        "totalExpense":
            MessageLookupByLibrary.simpleMessage("Συνολικές δαπάνες"),
        "totalIncome":
            MessageLookupByLibrary.simpleMessage("Συνολικό Εισόδημα"),
        "totalItems":
            MessageLookupByLibrary.simpleMessage("Συνολικά Αντικείμενα"),
        "totalLoss": MessageLookupByLibrary.simpleMessage("Ολική απώλεια"),
        "totalPayable":
            MessageLookupByLibrary.simpleMessage("Συνολικό πληρωτέο"),
        ...
        "updateProfile":
            MessageLookupByLibrary.simpleMessage("Ενημερώστε το προφίλ σας"),
        ...
        "updateYourSubscription":
            MessageLookupByLibrary.simpleMessage("Ενημερώστε τη συνδρομή σας"),
        ...
        "verifyYourEmail":
            MessageLookupByLibrary.simpleMessage("Επιβεβαιώστε το Email σας"),
        "verityEmail":
            MessageLookupByLibrary.simpleMessage("Επιβεβαίωση Email"),
        "viewAll": MessageLookupByLibrary.simpleMessage("Προβολή όλων"),
        "walkInCustomer":
            MessageLookupByLibrary.simpleMessage("Επισκέπτης Πελάτης"),
